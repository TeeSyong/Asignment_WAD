...
$sql="SELECT * FROM product WHERE name='Aeroready Sereno Slim Tapered Cut 3-Striped Pants'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if($row === FALSE)
  echo "Error for product Table: ". $sql."<br>".$conn->error;

$sql="SELECT * FROM images WHERE name='Aeroready Sereno Slim Tapered Cut 3-Striped Pants'";
  ...
  <?php include('../../../../includes/navigation.php'); ?>
    <div class="content_wrapper">
      ...
      <div class="right-container">
        ...
        <input type="hidden" name="productId" value="MP-<?php echo $row['id'];?>">
