...
$sql="SELECT * FROM product WHERE name='Train Essentials Seasonal Training Light Jacket'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if($row === FALSE)
  echo "Error for product Table: ". $sql."<br>".$conn->error;

$sql="SELECT * FROM images WHERE name='Train Essentials Seasonal Training Light Jacket'";
