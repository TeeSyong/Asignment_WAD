...
$sql="SELECT * FROM product WHERE name='Nike Sportswear Essential Repel' and colour='Black'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if($row === FALSE)
  echo "Error for product Table: ". $sql."<br>".$conn->error;

$sql="SELECT * FROM images WHERE name='Nike Sportswear Essential Repel' and colour='Black'";
      ...
      <div class="right-container">
        ...
        <div class="othercolours">
          <div class="othercolours_row">
            <img src="/ASIGNMENT_WAD/images/products/Clothing/Jackets/Nike/NikeSportswearEssentialRepel_Black_1.png" alt="NikeSportswearEssentialRepel_Black_1.png" onclick="location.href = 'NikeSportswearEssentialRepel_Black.php';">
          </div>
          <div class="othercolours_row">
            <img src="/ASIGNMENT_WAD/images/products/Clothing/Jackets/Nike/NikeSportswearEssentialRepel_White_1.png" alt="NikeSportswearEssentialRepel_White_1.png" onclick="location.href = 'NikeSportswearEssentialRepel_White.php';">
          </div>
        </div>
