...
$sql="SELECT * FROM product WHERE name='Nike Sportswear Essential Repel' and colour='White'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if($row === FALSE)
  echo "Error for product Table: ". $sql."<br>".$conn->error;

$sql="SELECT * FROM images WHERE name='Nike Sportswear Essential Repel' and colour='White'";
