...
$sql="SELECT * FROM product WHERE name='Adidas Original Mid-Cut Crew Socks 3 Pairs'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if($row === FALSE)
  echo "Error for product Table: ". $sql."<br>".$conn->error;

$sql="SELECT * FROM images WHERE name='Adidas Original Mid-Cut Crew Socks 3 Pairs'";
