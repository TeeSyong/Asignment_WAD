...
$sql="SELECT * FROM product WHERE name='Nike Gripknit Phantom GX Elite Dynamic Fit FG'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if($row === FALSE)
  echo "Error for product Table: ". $sql."<br>".$conn->error;

$sql="SELECT * FROM images WHERE name='Nike Gripknit Phantom GX Elite Dynamic Fit FG'";
