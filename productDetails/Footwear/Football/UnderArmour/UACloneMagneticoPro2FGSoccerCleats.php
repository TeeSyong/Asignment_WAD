...
$sql="SELECT * FROM product WHERE name='UA Clone Magnetico Pro 2 FG Soccer Cleats'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if($row === FALSE)
  echo "Error for product Table: ". $sql."<br>".$conn->error;

$sql="SELECT * FROM images WHERE name='UA Clone Magnetico Pro 2 FG Soccer Cleats'";
